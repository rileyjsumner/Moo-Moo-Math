        ...
        <div class = "content">
            ...
            <div class = "content">
                <div class ="text-center">
                    ...
                    <p></p>
                    <input type = "button" style = "background-color:#81C6C9; border: 4px solid #489194" onclick = "document.location.href = 'User?action=crud&crudaction=addform'" value = "New User"/>
                </div>
            </div>
        </div>
